...
export const metadata: Metadata = {
  title: "SACHHSOFT — Bespoke Software Development | Global",
  description:
    "SACHHSOFT builds custom software products for enterprise teams, mid-size companies, and startup founders. HealthTech, FinTech, E-Commerce, AI integration — delivered globally. 15+ companies launched. 1M+ users maintained.",
  alternates: { canonical: "https://sachhsoft.com" },
};

const homeFaqs = [
  { question: "What does SACHHSOFT do?", answer: "SACHHSOFT is a bespoke software development company that builds custom digital products for enterprise teams, mid-size companies, and startup founders. We specialize in HealthTech, FinTech, E-Commerce, Legal Tech, and AI integration, delivering globally." },
  ...
  { question: "Where is SACHHSOFT located?", answer: "SACHHSOFT serves clients globally across North America, Europe, the Middle East, and APAC." },
